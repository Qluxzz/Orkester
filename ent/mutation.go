...
// CoverCleared reports if the "cover" edge to the Image entity was cleared.
...
func (m *ImageMutation) SetImage(b []byte) {
	m.image = &b
}

// Image returns the value of the "image" field in the mutation.
func (m *ImageMutation) Image() (r []byte, exists bool) {
	v := m.image
	if v == nil {
		return
	}
...
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ImageMutation) OldImage(ctx context.Context) (v []byte, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ImageMutation) SetImageMimeType(s string) {
	m.image_mime_type = &s
}

// ImageMimeType returns the value of the "image_mime_type" field in the mutation.
func (m *ImageMutation) ImageMimeType() (r string, exists bool) {
	v := m.image_mime_type
	if v == nil {
		return
	}
...
// OldImageMimeType returns the old "image_mime_type" field's value of the Image entity.
// If the Image object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ImageMutation) OldImageMimeType(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ImageMutation) ResetImageMimeType() {
...
func (m *ImageMutation) Fields() []string {
	...
	if m.image_mime_type != nil {
		fields = append(fields, image.FieldImageMimeType)
	}
	if m.hash != nil {
...
// SearchPathMutation represents an operation that mutates the SearchPath nodes in the graph.
type SearchPathMutation struct {
	config
	op            Op
	typ           string
	id            *int
	...
	oldValue      func(context.Context) (*SearchPath, error)
	predicates    []predicate.SearchPath
}

var _ ent.Mutation = (*SearchPathMutation)(nil)

// searchpathOption allows management of the mutation configuration using functional options.
type searchpathOption func(*SearchPathMutation)

// newSearchPathMutation creates new mutation for the SearchPath entity.
func newSearchPathMutation(c config, op Op, opts ...searchpathOption) *SearchPathMutation {
	m := &SearchPathMutation{
		config:        c,
		op:            op,
		typ:           TypeSearchPath,
		clearedFields: make(map[string]struct{}),
...
// withSearchPathID sets the ID field of the mutation.
func withSearchPathID(id int) searchpathOption {
	return func(m *SearchPathMutation) {
		var (
			err   error
			once  sync.Once
			value *SearchPath
		)
		m.oldValue = func(ctx context.Context) (*SearchPath, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().SearchPath.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withSearchPath sets the old SearchPath of the mutation.
func withSearchPath(node *SearchPath) searchpathOption {
	return func(m *SearchPathMutation) {
		m.oldValue = func(context.Context) (*SearchPath, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m SearchPathMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m SearchPathMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *SearchPathMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *SearchPathMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().SearchPath.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
func (m *SearchPathMutation) SetPath(s string) {
	m._path = &s
}

// Path returns the value of the "path" field in the mutation.
func (m *SearchPathMutation) Path() (r string, exists bool) {
	v := m._path
	if v == nil {
		return
	}
...
// OldPath returns the old "path" field's value of the SearchPath entity.
// If the SearchPath object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SearchPathMutation) OldPath(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SearchPathMutation) ResetPath() {
	m._path = nil
}

// Where appends a list predicates to the SearchPathMutation builder.
func (m *SearchPathMutation) Where(ps ...predicate.SearchPath) {
	m.predicates = append(m.predicates, ps...)
}
...
func (m *SearchPathMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *SearchPathMutation) Fields() []string {
	fields := make([]string, 0, 1)
	if m._path != nil {
		fields = append(fields, searchpath.FieldPath)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *SearchPathMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *SearchPathMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case searchpath.FieldPath:
		return m.OldPath(ctx)
	}
	return nil, fmt.Errorf("unknown SearchPath field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SearchPathMutation) SetField(name string, value ent.Value) error {
	switch name {
	case searchpath.FieldPath:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown SearchPath field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *SearchPathMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *SearchPathMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SearchPathMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown SearchPath numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *SearchPathMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *SearchPathMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *SearchPathMutation) ClearField(name string) error {
	return fmt.Errorf("unknown SearchPath nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *SearchPathMutation) ResetField(name string) error {
	switch name {
	case searchpath.FieldPath:
		m.ResetPath()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *SearchPathMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *SearchPathMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *SearchPathMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *SearchPathMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *SearchPathMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *SearchPathMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *SearchPathMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown SearchPath unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *SearchPathMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown SearchPath edge %s", name)
}
...
func (m *TrackMutation) ImageIDs() (ids []int) {
...
func (m *TrackMutation) ResetImage() {
	m.image = nil
...
func (m *TrackMutation) AddedEdges() []string {
	...
	if m.image != nil {
		edges = append(edges, track.EdgeImage)
	}
	return edges
}
