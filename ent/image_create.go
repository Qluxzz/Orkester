...
func (ic *ImageCreate) SetImage(b []byte) *ImageCreate {
	ic.mutation.SetImage(b)
	return ic
}

// SetImageMimeType sets the "image_mime_type" field.
func (ic *ImageCreate) SetImageMimeType(s string) *ImageCreate {
	ic.mutation.SetImageMimeType(s)
	return ic
}
...
func (ic *ImageCreate) check() error {
	...
	if _, ok := ic.mutation.ImageMimeType(); !ok {
		return &ValidationError{Name: "image_mime_type", err: errors.New(`ent: missing required field "Image.image_mime_type"`)}
	}
...
func (ic *ImageCreate) createSpec() (*Image, *sqlgraph.CreateSpec) {
	...
	if value, ok := ic.mutation.Image(); ok {
		_spec.SetField(image.FieldImage, field.TypeBytes, value)
		_node.Image = value
	}
	if value, ok := ic.mutation.ImageMimeType(); ok {
		_spec.SetField(image.FieldImageMimeType, field.TypeString, value)
